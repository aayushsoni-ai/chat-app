...
const MessageContainer = () => {
        ...
        <div
          className={`${
            message.sender !== selectedChatData._id
              ? " text-[#eba46d]/90 border-[#eba46d]/50"
        ...
        >
          {checkIfImage(message.fileUrl) ? (
            ...
            <div className="flex items-center justify-center gap-4">
              <span className="bg-black/20 text-white/80 rounded-full p-3 text-3xl">
                <MdFolderZip />
              </span>
              <span>{message.fileUrl.split("/").pop()}</span>
              <span
                className="bg-black/20 text-2xl rounded-full p-3 hover:bg-black/50 transition-all duration-300"
  ...
  return (
    <div className="flex-1 overflow-y-auto scrollbar-hidden p-4  md:w-[65vw] lg:w-[70vw] xl:w-[80vw] w-[100%] max-h-screen">
      {renderMessages()}
      <div ref={scrollRef} />
      {showImage && (
        <div className="fixed z-[1000] top-0 left-0 h-[100vh] w-[100vw] flex items-center justify-center backdrop-blur-lg flex-col">
          ...
          <div className="flex gap-5 fixed top-0 mt-5">
            <button
              className="bg-[#eba46d]/80 p-3 text-2xl rounded-full hover:bg-white/60 cursor-pointer transition-all duration-300"
