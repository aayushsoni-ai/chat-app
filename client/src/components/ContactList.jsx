        ...
        <div
          ...
          className={`pl-10 py-2 transition-all duration-300 cursor-pointer ${
            selectedChatData && (selectedChatData._id === contact._id)
              ? "bg-[#663a18] hover:bg-[#c18455]"
              : "hover:bg-[#f1f1f111]"
          }`}
          onClick={() => handleClick(contact)}
        >
          <div className="flex gap-5 items-center justify-start text-neutral-300 font-serif">
            {
                ...
                {contact.image ? (
                  ...
                  <div
                    className={`
                        ...
                        uppercase h-10 w-10 text-lg border-[0.5px] flex items-center justify-center rounded-full  
                        `}
                  >
                    {contact.firstName
